  ...
  <div class="container">
    ...
    <div class="project-shell border border-dark ">
      ...
      <div class="row g-5 align-items-start">
        ...
        {{-- RIGHT: image --}}
        <div class="col-lg-3" style=" padding: 180px 100px 40px 40px; background-color: white;">
...
@media (max-width: 991px){
  ...
  .project-hero-media{ position: relative; top:auto; }
  .project-hero-img, .project-hero-empty{ height: 360px; }
}
</style>
@endpush
